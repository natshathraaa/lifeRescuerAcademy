      ...
      >
        <div>
          <div className="flex items-center gap-3">
            <span className="rounded-xl bg-white p-2 shadow-sm inline-block">
              <img
                src="/brand/logo.png"
                alt="Life Rescuer Academy logo"
                className="h-9 w-auto object-contain shrink-0"
              />
            </span>
            <span className="font-bold text-white text-[17px]">{site.name}</span>
          </div>
